...
//		//driver.quit();
		...
		WebElement element = driver.findElement(By.xpath("//h1[text()='LambdaTest Documentation and Knowledge Hub']"));
		...
		driver.findElement(By.xpath("//div[@class='rsw-ce']")).sendKeys("Hello");
